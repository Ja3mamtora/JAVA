...
class Main {
    public static void main(String[] args) throws ExecutionException {
        Triplet<String, Integer, Character> p1 = Triplet.of("OM MODI", 20, 'M');
        Triplet<String, Integer, Character> p2 = Triplet.of("JATIN", 20, 'M');
        Triplet<String, Integer, Character> p3 = Triplet.of("NIRMIT", 20, 'M');
